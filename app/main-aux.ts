...
@Component({
    ...
    styles: [`.home {background: red; padding: 15px 0 0 30px; height: 80px; width: 70%; float: left; 
...
@Component({
    ...
    styles: [`.chat {background: #eee; height: 80px; width: 30%; font-size: 24px; float: left;
